...
export default function RecentPurchasesCard({ data }: { data: ContactsLastInvoiceData }) {
            ...
            <CardHeader className="p-0">
                ...
                <CardDescription>
                    <span className="hidden sm:inline">
                        An overview of recent purchases made by you, including product details and purchase dates.
                    </span>
